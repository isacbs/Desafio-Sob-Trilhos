...
import time
import os
from faseMedia import fase_media  # Importa a fase média de outro arquivo

# Inicializa o Pygame
pygame.init()

# Caminho base seguro para recursos
...
def fase_facil():
    ...
    while running:
        ...
        if prota.rect.y < 10:
            fase_media()  # Ao vencer a fase fácil, inicia a fase média
            return
