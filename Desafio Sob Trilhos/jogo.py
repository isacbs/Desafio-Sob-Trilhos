...
# Protagonista
prota_img = pygame.transform.scale(pygame.image.load("imgs/prota_parada.png"), (100,100))
prota_andando_img = pygame.transform.scale(pygame.image.load("imgs/prota_andando.png"), (100,100))
prota_pensando_img = pygame.transform.scale(pygame.image.load("imgs/prota_pensando.png"), (100,100))

# NPCs
npc_images = [pygame.transform.scale(pygame.image.load(f"imgs/npc{i}.png"), (100,100)) for i in range(1, 7)]
...
class NPC(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.speed = random.choice([2, 2.5, 3])  # Aumentada a velocidade
...
class Protagonista(pygame.sprite.Sprite):
    ...
    def update(self, keys_pressed, npc_group):
        ...
        # Colisão com NPC reduz ainda mais a velocidade
