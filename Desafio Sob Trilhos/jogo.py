...
nome_image = pygame.transform.scale(pygame.image.load(os.path.join(IMG_DIR, "nome.png")), (810, 635))
...
# Definição das áreas de colisão da fase inicial
COLLISION_AREA_LEFT = pygame.Rect(0, 300, 400, 100)
COLLISION_AREA_RIGHT = pygame.Rect(500, 300, 300, 100)
PASSAGEM = pygame.Rect(400, 300, 100, 100)  # Área que o jogador pode passar
...
class NPC(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # Mantém o NPC dentro dos limites da tela
...
class Protagonista(pygame.sprite.Sprite):
    ...
    def update(self, keys_pressed, npc_group):
        moved = False
        self.last_position = self.rect.copy()  # Salva posição atual antes de mover
        ...
        # Reduz velocidade se colidir com algum NPC
...
def tela_nome():
    ...
    # Área retangular onde o texto será digitado
    input_rect = pygame.Rect(SCREEN_WIDTH//2 - 200, SCREEN_HEIGHT//2 - 20, 400, 80)
    ...
    while running:
        ...
        # Posiciona o texto na área correta
        text_pos = txt_surface.get_rect(center=(input_rect.centerx, input_rect.centery - 40))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_BACKSPACE:
                    ...
                    # Inicia o jogo se houver texto digitado
...
def fase_facil(player_name=None):
    ...
    # Configuração do tempo limite da fase
    tempo_limite = 120
    ...
    while running:
        ...
        # Atualiza posição do protagonista e NPCs
...
def menu():
    ...
    # Define a área de cada botão para detecção de cliques
