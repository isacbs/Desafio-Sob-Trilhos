...
class Quiz:
    def __init__(self, player_name, tempo_total):
        ...
        # Perguntas do quiz com opções, respostas corretas e imagens
        self.questions = [
            {
    ...
    def show_feedback(self, is_correct):
        ...
        pygame.display.flip()
        pygame.time.delay(1500)  # Pausa para que o jogador veja o feedback
    ...
    def run(self):
        for self.current_question in range(len(self.questions)):
            ...
            # Aguarda o jogador selecionar uma resposta
        ...
        # Exibe o resultado final e vai para o ranking
        self.show_result()
        # Direciona para o ranking com as informações do jogador
